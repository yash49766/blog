...
import { RocketLaunch as RocketIcon, TrendingUp as TrendingUpIcon, AccessTime as AccessTimeIcon } from '@mui/icons-material';
...
function StartingUp() {
    ...
    const ideaArticles = articles.filter(article => article.type === 'Starting Up');
        ...
        <>
            ...
            >
                <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
                    ...
                    >
                        Learn the vital tasks you need to start your business and set yourself up for success.
                    </Typography>
                </Container>
            </Box>
                                        ...
                                        sx={{
                                            '& .MuiPaginationItem-root': {
                                                ...
                                                '&.Mui-selected': {
                                                    ...
                                                    color: 'white',
                                                    '&:hover': {
                                                        background: 'linear-gradient(45deg, #e55353, #d63031)',
                                                    }
                                                }
                                            }
                                        }}
